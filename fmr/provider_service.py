...
def prepare_handoff(job: ModelJob | dict[str, Any], *, policy_name: str | None = None, registry: ProviderRegistry | None = None, plugins: PluginCatalog | None = None) -> dict[str, Any]:
